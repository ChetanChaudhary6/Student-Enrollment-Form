...
var connectionToken = '90932541|-31949277169539027|90949232';
...
function validateFormData() {
    ...
    if (className === '') {
        alertHandler(0, 'Class Name Missing');
        $('#class').focus();
        return "";
    }
    ...
    if (birthDate === '') {
        alertHandler(0, 'Birth Date Missing');
        $('#birthDate').focus();
        return "";
    }
    if (name === '') {
        alertHandler(0, 'Full-Name Missing');
        $('#fullName').focus();
        return "";
    }
    if (address === '') {
        alertHandler(0, 'Address Missing');
        $('#address').focus();
        return "";
    }
    if (enrollmentData === '') {
        alertHandler(0, 'Enrollment Data Missing');
